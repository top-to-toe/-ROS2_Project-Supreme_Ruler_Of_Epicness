...
public:
    ...
    WaypointsNavigationNode(const rclcpp::NodeOptions &options)
        : Node("waypoints_navigation_node", options)
    {
        // 액션 클라이언트 생성
        ...
        this->timer_ = this->create_wall_timer(
            ...
            std::bind(&WaypointsNavigationNode::send_waypoints_goal, this));
    }
...
private:
    ...
    void send_waypoints_goal()
    {
        ...
        send_goal_options.goal_response_callback =
            std::bind(&WaypointsNavigationNode::goal_response_callback, this, std::placeholders::_1);
        send_goal_options.feedback_callback =
            std::bind(&WaypointsNavigationNode::feedback_callback, this, std::placeholders::_1, std::placeholders::_2);
        send_goal_options.result_callback =
            std::bind(&WaypointsNavigationNode::result_callback, this, std::placeholders::_1);
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<WaypointsNavigationNode>(rclcpp::NodeOptions()); // 노드 생성
